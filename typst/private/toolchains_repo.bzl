...
PLATFORMS = {
    ...
    "armv7-unknown-linux-musleabi": struct(
        compatible_with = [
            "@platforms//os:linux",
            "@platforms//cpu:armv7",
        ],
...
# By default all these toolchains are registered by the typst_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:typst_toolchain",
